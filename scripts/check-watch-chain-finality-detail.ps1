...
$repo = "watch-chain-finality-scope"
$language = "C"
$category = "Blockchain tooling"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/watch-chain-finality-walkthrough.md")) {
