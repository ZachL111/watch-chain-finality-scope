"""Regression checks for the watch-chain-finality-scope casebook."""
...
from casebook.harness import assert_expected, watch_chain_finality_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(watch_chain_finality_scope_summary(), assert_expected())
